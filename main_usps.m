...
% Power of Laplacian
k = 4; % higher k leads to better estimate of the cut-off frequency
...
figure, errorbar(labelled_percentage, mean(1-error_list,2),std(1-error_list,0,2),'-sb');
